...
<head>
    ...
    <script src="https://cdnjs.cloudflare.com/ajax/libs/Blob.js/0.1.4/Blob.min.js"></script>
                                                            ...
                                                            <div class="">
                                                                ...
                                                                <table class="table display responsive nowrap w-100" id="modal_table">
                                                                    ...
                                                                    <tbody id="modal_table_body">
                                                                      <!-- <tr>
                                                                            <td><input type="text" readonly class="form-control input_size Mline_numm text-right"></td>
                                                                            <td><input type="text" readonly class="form-control input_size Monee text-right"></td>
                                                                            <td><input type="text" readonly class="form-control input_size Mpo_type text-right"></td>
                                                                            <td><input type="text" readonly class="form-control input_size Mpo_item text-right"></td>
                                                                            <td><input type="text" readonly class="form-control input_size Mdetail_company_code text-right"></td>
                                                                            <td><input type="text" class="form-control input_size Mdetails_statuss text-right"></td>
                                                                            <td><input type="text" readonly class="form-control input_size Mcurrency text-right"></td>
                                                                            <td><input type="text" readonly class="form-control input_size Munit_cost text-right"></td>
                                                                            <td class="d-none"><input type="text" readonly id="" class="form-control input_size Morder_quantity text-right"></td>
                                                                            <td class="d-none"><input type="text" readonly id="" class="form-control input_size Morder_recieved text-right"></td>
                            ...
                            <div class="ibox-content p-2 ">
                                <div class="text-center  my-2 d-flex justify-content-around">
                                    <input type="button" id="btn_panel"
                                        ...
                                        <input type="button" class="add_info btn btn-primary" data-toggle="modal" data-target="#myModal11" readonly id="modeldata" value="Additional Info">
                                        <input type="button" class="add_info btn btn-primary" data-toggle="modal" data-target="#myModal17" readonly id="modeldata" value="Additional Doc."></div>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="container-fluid">
                                        ...
                                        <div class="panel-body">
                                            <div class="row">
                                                ...
                                                <div class="col-6 b-r" id="form1">
                                                    ...
                                                    <div class="input-group col p-0"> 
                                                        <label
                                                            class="col-4 col-form-label p-0 mr-2" for="storeId">Store ID
                                                        </label>
                                                            <select id="storeId" disabled class="form-control input_size fetch_check">
                                                            </select>
                                                        <div class=" input-group-append">
                                                            <button type="button" id="comp_select" class="btn btn-secondary d-none select"
                                                                data-toggle="modal" data-target="#myModal5">
                            ...
                            <div class="row">
                                <div class="col-12">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-6 b-r" id="form3">
                                                    ...
                                                    <div class="form-group row"><label
                                                        ...
                                                        <div class="col-4">
                                                            <input type="text" placeholder="Enter Invoice No." class="form-control input_size fetch_check check_grn"
                                                                required="" id="invoice_noo_entry">
                                                        </div>
                                                        <div class="col-4">
                                                            <input type="text" readonly class="form-control input_size check_grn fetch_check check_grn"
                                    ...
                                    <div class="form-group row" id="road"><label
                                            ...
                                            required="" id="supplier_gstin">
                                                ...
                                                <div class="col-6" id="form4">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-8"><input type="date" class="form-control input_size fetch_check check_grn"
                                                             readonly required="" id="invoice_date">
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        <label class="col-4 col-form-label">GL Date</label>
                                                        <div class="col-8"><input type="date" readonly class="form-control input_size fetch_check check_grn"
                                                                required="" id="gl_date">
                                                        </div>
                                                    </div>
                                                    <div class="form-group row"><label class="col-4 col-form-label">Amount</label>
                                                    ...
                                                    <div class="form-group row"><label
                                                        ...
                                                        <div class="col-8">
                                                            <!-- <input type="text" class="form-control input_size fetch_check"
                                                                required="" id="source"> -->
                                                                <select name="" class="form-control input_size fetch_check outline-none" id="source" disabled>
                                                                    <!-- <option value=""></option> -->
                                                                    <option value="">OCR</option>
                                                                    <option value="">Manual</option>
                                                                </select>
                                        ...
                                        <div class="p-0">
                                            ...
                                            <div class="tabs-container">
                                                ...
                                                <ul class="nav nav-tabs" role="tablist">
                                                    ...
                                                    <li id="data_list1"><a class="nav-link" id="data2" data-toggle="tab" href="#tab-12">Quality</a></li>
                                                                            ...
                                                                            <table class="table table-bordered" id="tab_logicc">
                                                                                <thead>
                                                                                    <tr>
                                                                                        ...
                                                                                        <th class="text-center fix_length px-0 description_grn">Description</th>
                                                    ...
                                                    <div role="tabpanel" id="tab-11" class="tab-pane" >
                                                        <div class="panel-body" id="grn_table_fix">
                                                            <div class="row d-flex justify-content-end mx-2">
                                                                <div class="container-fluid">
                                                                    <div class="container-fluid clearfix">
                                                                        <button type="button" id="export-button" class="btn btn-primary mb-2">Export to Excel</button>
                                                                        <div class="">
                                                    ...
                                                    <div role="tabpanel" id="tab-12" class="tab-pane">
                                                        ...
                                                        <div class="panel-body">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-12" id="for_slider">
                                                                    ...
                                                                    <table id="Dtable_view"
                                                                        ...
                                                                        <thead>
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <th class="text-left" data-hide="phone">Item Desc.</th>
                                                                                ...
                                                                                <th class="text-left" data-hide="phone,tablet">Doc. No.</th>
...
<!-- adsfadfs -->
<div class="row for_width" id="create-vc">
    <div class="col-12">
        <div class="panel panel-primary ">
            
            <div class="panel-body d-flex" >
                <input type="button" id="create_voucher" class="btn col-3  border btn-primary " value="Create Voucher">
                <input type="button" class="btn btn-primary col-3 invisible" id="calculate_diffrence" value="Calculate Diffrence"> &nbsp;&nbsp;&nbsp;
...
<div class="row for_width" >
        ...
        <div class="panel panel-primary">
            ...
            <div class="panel-body d-flex" >
                ...
                <!-- <div class="container px-1">
                    <input type="button" id="submit_invoice"  class="btn col-sm-12 btn-primary" value="Submit">
                </div> -->
                <div class="container px-1">
    ...
    <script src="../js/addLine.js" + $.getCurrentVersion()></script>
    <script src="../js/viewVoucher.js" + $.getCurrentVersion()></script>
</body>
