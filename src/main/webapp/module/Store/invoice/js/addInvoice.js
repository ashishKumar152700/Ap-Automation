...
$(document).ready(function(){
  ...
  $("#modal_table_body").append(modalRow)
	  ...
	  $("#add_roww").click(()=>{
		...
		<td class="text-center p-0 d-none"><input type="text" class="form-control input_size details_statuss text-center" id=""></td>
		...
		<td class="text-center p-0"><input type="text" id=""  class="form-control input_size CGST_Amount text-center"></td>
		<td class="text-center p-0"><input type="text" id=""  class="form-control input_size SGST_Amount text-center"></td>
		<td class="text-center p-0"><input type="text" id=""  class="form-control input_size IGST_Amount text-center"></td>
