...
$(document).ready(function(){
  ...
  $("#modal_table_body").append(modalRow)
	  ...
	  $("#add_roww").click(()=>{
		...
		<td class="text-left"><span class="minus-box delete-icon bg-danger"><i class="fa fa-minus"></i></span></td>
		<td class="text-left p-0"><input type="text" readonly class="form-control input_size detail_company_code text-left" id="" ></td>
		<td class="text-left p-0"><input type="text" readonly class="form-control input_size onee text-left" id="po_number"></td>
		<td class="text-left p-0"><input type="text" readonly id="po_type" class="form-control input_size po_type text-left"></td>
		<td class="text-left p-0"><input type="text" readonly class="form-control input_size line_numm text-left" id="line_number"></td>
		<td class="text-left p-0"><input type="text" readonly class="form-control input_size po_item text-left" id="item_code" ></td>
		<td class="text-left p-0"><input type="text" readonly class="form-control input_size description_item text-left" id="" ></td>
		<td class="text-left p-0"><input type="text" readonly class="form-control input_size cost_rule text-left" id="" ></td>
		<td class="text-left p-0"><input type="text" readonly id="uom" class="form-control input_size currency text-left"></td>
		<td class="text-left p-0"><input type="text" readonly id="unit_cost" class="form-control input_size unit_cost text-right"></td>
		<td class="text-left p-0 d-none"><input type="text" class="form-control input_size details_statuss text-right" id=""></td>
		<td class="text-left p-0"><input type="text" readonly class="form-control input_size open_quantity text-right" id=""></td>
		<td class="text-left p-0 d-none"><input type="text" readonly id="" class="form-control input_size order_quantity text-right"></td>
		<td class="text-left p-0 d-none"><input type="text" readonly id="" class="form-control input_size order_recieved text-right"></td>
		<td class="text-left p-0"><input type="text" id="" class="form-control input_size accept_quantity check_grn text-right"></td>
		<td class="text-left p-0"><input type="text" id="" readonly class="form-control input_size CGST_Amount text-center"></td>
		<td class="text-left p-0"><input type="text" id="" readonly class="form-control input_size SGST_Amount text-center"></td>
		<td class="text-left p-0"><input type="text" id="" readonly class="form-control input_size IGST_Amount text-center"></td>
		<td class="text-left p-0"><input type="text" id="" readonly class="form-control input_size taxable_value text-right"></td>
		<td class="text-left p-0"><input type="text" id="" readonly class="form-control input_size taxable_amount_payload text-right"></td>
		<td class="text-left p-0 d-none"><input type="text" id="" readonly class="form-control input_size description text-right"></td>
		<td class="text-left p-0 d-none"><input type="text" id="" readonly class="form-control input_size Location text-center"></td>
		<td class="text-left p-0 d-none"><input type="text" id="" readonly class="form-control input_size business_detail text-right"></td>
		</tr>`;
	...
	$('#grn_row').click(function() {
		...
		<td class="d-none"><input type="text" readonly class="form-control input_size location text-right d-none"></td>
