...
<body>
    ...
    <div class="wrapper wrapper-content animated fadeInRight">
              ...
              <div class="row my-1 py-1 justify-content-around">
                ...
                <!-- <div class=""> -->
                  ...
                  <div class="col-2 p-0" style="display: flex;align-items: center;">
                    <input class="form-check-input" type="checkbox" id="override_taxable_value" disabled>
      ...
      <div class="row d-flex justify-content-center">
        <div class="col-md-9 docs-buttons d-flex justify-content-center">
          ...
          <div class="btn-group d-none">
            <button type="button" id="handle" class="btn btn-primary" data-method="setDragMode" data-option="move" title="Move">
      ...
      <div class="ibox-content sk-loading" id="loader">
        <div class="sk-spinner sk-spinner-double-bounce">
          ...
          <button type="button" class="btn btn-primary" id="back_invoice">Back</button>
    </div>
  ...
  <script src="../js/viewTemplate.js?v=" + $.getCurrentVersion()></script>
  ...
  <script src="../../../../custom/cropper/js/viewmain.js"></script>
