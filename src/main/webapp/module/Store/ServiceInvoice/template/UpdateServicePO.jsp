...
<head>
    ...
    <title>Service PO Invoice</title>
                            ...
                            <div class="ibox-content p-2 ">
                                <div class="text-center  my-2 d-flex justify-content-around">
                                    <input type="button" id="btn_panel"
                                        ...
                                        <input type="button" class="add_info btn btn-secondary" readonly="" id="reMap" value="Re-Map">
                                    </div>
                                </div>
                            </div>
                        </div>
                                                                            ...
                                                                            <table class="table table-bordered" id="tab_logicc">
                                                                                <thead>
                                                                                    <tr>
                                                                                        ...
                                                                                        <th class="text-left fix_len px-0 co_code"> Co. Code</th>
                                                                                        <th class="text-left fix_len px-0 po_code"> PO No.</th>
                                                                                        <th class="text-left fix_len px-0 po_ty_code"> PO Type</th>
                                                                                        <th class="text-left px-0 line_code"> Line No.</th>
                                                                                        <th class="text-left fix_length px-0 item_code_grn"> Item No</th>
                                                                                        <th class="text-left fix_length px-0 description_grn">Item Description</th>
                                                                                        <th class="text-left fix_len px-0 cost_rule_head"> Cost Rule</th>
                                                                                        <th class="text-left fix_len px-0 uom_code"> UOM</th>
                                                                                        <th class="text-right fix_len px-0 unit_rate_code"> Unit Rate</th>
                                                                                        <th class="text-right fix_len px-0 ord_qty_code d-none"> Order Qty.</th>
                                                                                        <th class="text-right fix_len px-0 open_qty_code"> Open Qty.</th>
                                                                                        <!-- <th class="text-center fix_len px-0 scanned_code"> Scanned/Invoice Qty.</th> -->
                                                                                        <th class="text-right fix_len px-0 actual_code"> Actual Recieved Qty.</th>
                                                                                        ...
                                                                                        <th class="text-right fix_len px-0 taxable_code"> Taxable value</th>
                                                                                        <th class="text-right fix_len px-0 taxable_amount">Total Tax Amount</th>
                                                                                        <th class="text-right px-0 description_head d-none">Description</th>
                                                                                        <th class="text-center px-0 Location_head d-none">Location</th>
                                                                                        <th class="text-right px-0 business_detailsss d-none">Business Unit</th>
                                                                                        <th class="text-right px-0 row_incrementt d-none">row id</th>
                                                                                ...
                                                                                <tbody id="table-body">
                                                                                  <tr>
                                                                                        ...
                                                                                        <td class="text-center p-0 d-none"><input type="text" id=""  readonly class="form-control input_size row_increment text-right"></td>
                                                                                        <!-- <td><input type="text" id="item_code" readonly class="form-control input_size next_status text-right"></td>
                                                                                        <td><input type="text" id="hsn_code" readonly class="form-control input_size last_status text-right"></td> -->
                                                                            ...
                                                                            <table class="table table-bordered" id="grn_table">
                                                                                <thead>
                                                                                    <tr>
                                                                                        ...
                                                                                        <th class="text-center fix_grn_len d-none"> Location</th>
...
<!-- <div class="col-12"> -->
    ...
    <script src="../js/UpdateServicePO.js?v=" + $.getCurrentVersion()></script>
