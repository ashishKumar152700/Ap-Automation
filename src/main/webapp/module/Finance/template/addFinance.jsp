...
<body>
    ...
    <script>
        ...
        if(name != null)
        {
            ...
            //  if(name.includes("Finance")  || name.includes("Admin"))
...
<div class="row for_width" >
    ...
    <script src="../js/addLineFinance.js" + $.getCurrentVersion()></script>
    <script src="../js/addFinance.js" + $.getCurrentVersion()></script>
</body>
