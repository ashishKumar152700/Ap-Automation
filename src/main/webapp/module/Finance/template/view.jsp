                    ...
                    <div class="ibox-content sk-loading" id="loader2">
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <input type="button" id="cancel" class="btn col-sm-1 btn-success border" value="Back">
                                <input type="button" id="reject_invoice" class="btn col-sm-6 btn-danger border d-none"
                                    value="Reject">
