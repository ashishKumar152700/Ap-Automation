  ...
  <script>
    ...
    <div id="wrapper">
                      ...
                      <form class="contact-form" id="form">
                        <div class="controls">
                          <div class="row">
                            ...
                            <div class="col-1"></div>
                            <div class="col-md-4">
                              <div class="form-group"><label>From Unit*</label> <input type="text" name="fromUnit" placeholder="fromUnit" class="form-control" id="fromUnit"></div>
                              <div class="form-group"><label>Conversion Factor*</label><input type="text"  placeholder="Conversion Factor" name="conversionFactor" class="form-control" id="conversionFactor" required=""></div>
                            </div>

                            <div class="col-2"></div>
                            <div class="col-md-4">
                                <div class="form-group"><label>To Unit*</label><input type="text"  placeholder="To Unit" name="toUnit" class="form-control" id="toUnit" required=""></div>
                            </div>
       ...
       <script src="../../../../static/js/plugins/jquery-ui/jquery-ui.min.js"></script>
         ...
         <script src="../js/addUOM.js"></script>
