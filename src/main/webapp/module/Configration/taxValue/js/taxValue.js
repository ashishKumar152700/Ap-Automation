$(document).ready(() => {
    ...
    var tab = $("#Dtable").DataTable({
        ...
        ajax: {
            ...
            url: `http://192.168.50.81:8080/ap_automation_backend/tax/list`,
            dataSrc: "data",
            headers: {
    ...
    $("#Dtable").on("click", ".delete", function () {
        ...
        swalWithBootstrapButtons.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: `http://192.168.50.81:8080/ap_automation_backend/tax/delete?id=${row}`,
                    type: "delete",
                    dataSrc: "data",
                    headers: {
                        'Authorization': 'Bearer ' + token,
        ...
        $.ajax({
            ...
            success: function (data,status,xhr) {
                if(xhr.status == 200)
                {
                    ...
                    window.location.href = `../template/updateTaxValue.jsp`;
                }
                else{
    ...
    //                 $("#tax").val(data.data[0].tax).css("font-weight", "bold");
    //                 $("#type").val(data.data[0].type).css("font-weight", "bold");
    //             }
    //             else{
