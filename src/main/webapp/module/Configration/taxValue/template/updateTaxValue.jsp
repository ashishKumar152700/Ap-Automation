...
<body>
  ...
  <script>
    ...
    <div id="wrapper">
                      ...
                      <form class="contact-form" id="form1">
                        <div class="controls">
                          <div class="row">
                            <div class="col-1"></div>
                            <div class="col-md-4">
                              <div class="form-group"><label>Tax*</label> <input type="text" placeholder="Tax" class="form-control" required="" maxlength="12 " id="input-text1"></div>
                            </div>
                            <div class="col-2"></div>
                            <div class="col-md-4">
                              <div class="form-group"><label>Type*</label><input type="text" placeholder="Type" class="form-control" required="" maxlength="12" id="input-text2"></div>
                            </div>
       ...
       <script src="../js/updateTaxValue.js"></script>
