...
<body>
                                            ...
                                            <div class="d-flex ">
                                                <div class="input-group ">
                                                    <input type="text" class="form-control column_filter"
                                                        placeholder="Tax" aria-label="Admin Theme"
                    ...
                    <div class="ibox ">
                        <div class="ibox-content py-2">
                            <div class="text-center my-2">
                                <a class="btn btn-primary" href="addTaxValue.jsp"><i class="fa fa-plus"> </i> Add
                                    Tax</a>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="ibox-content">
                            <table id="Dtable" class="display responsive nowrap text-left" style="width: 100%">
                                <thead>
                                    ...
                                    <th class="text-left" data-hide="phone">Tax</th>
                                            ...
                                            <form class="contact-form" id="form">
                                              <div class="controls">
                                                <div class="row">
                                                  <div class="col-1"></div>
                                                  <div class="col-md-4">
                                                    <div class="form-group"><label>Tax*</label> <input type="text" placeholder="Tax" class="form-control" id="tax" required="" maxlength="12 " disabled ></div>
                                                  </div>
                                                  <div class="col-2"></div>
                                                  <div class="col-md-4">
                                                    <div class="form-group"><label>Type*</label><input type="text"  placeholder="Type" class="form-control" id="type" required="" maxlength="12" disabled></div>
                                                  </div>
                                                  </div>
    ...
    <!-- TaxValue JS -->
    <script src="../js/taxValue.js"></script>
