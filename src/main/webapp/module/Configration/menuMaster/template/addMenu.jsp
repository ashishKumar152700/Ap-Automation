...
<html>
    ...
    <head>
        ...
        <link rel="stylesheet" href="../../../../custom/js/filter-multi-select-bundle.min.js">
...
<body>
  ...
  <script>
                            ...
                            <div class="col-md-4">
                              ...
                              <div class="form-group">
                                ...
                                <select  id="menu_type" class="form-control">
                                  ...
                                  <option value="PC">Parent & clickable</option>
    ...
    <script src="../js/addMenu.js?v=" + $.getCurrentVersion()></script>
