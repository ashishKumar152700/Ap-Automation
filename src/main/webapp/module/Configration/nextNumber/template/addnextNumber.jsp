...
<head>
    ...
    <link href="../css/addnextNumber.css" rel="stylesheet">
...
<body>
                                    ...
                                    <div class="controls">
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div class="form-group">
                                                    <label>Process*</label>
                                                    <input type="text" maxlength="10" id="process" placeholder="Process"
                                                        class="form-control">
                                                </div>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label>Year*</label>
                                                    <input type="text" maxlength="8" id="year" disabled
                                                        class="form-control">
                                                </div>
                                                <div class="form-group">
                                                    <label>Length *</label>
                                                    <input type="number" maxlength="25" id="length"
                                                        placeholder="Enter length" class="form-control">
                                                </div>
                                                <div class="form-group">
                                                    <label for="gatetype">Type*</label> <br>
                                                    <select id="gatetype" name="gatetype" class="form-control">
                                                        <option value="" disabled selected>No Type Selected
                                                ...
                                                <div class="form-group ">
                                                    <label for="gateId" id="gateIDLabel" >Gate Id*</label> <br>
                                                ...
                                                <div class="form-group custom-control custom-switch">
                                                    <input type="checkbox" class="custom-control-input"
                                                        id="toggle-switch">
                                                    <label class="custom-control-label" for="toggle-switch"
                                                        id="toggle-label">Inactive</label>
                                                </div>
    ...
    <!-- addNextNumber JS -->
    <script src="../js/addnextNumber.js?v=" + $.getCurrentVersion()></script>
