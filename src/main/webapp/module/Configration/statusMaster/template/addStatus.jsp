  ...
  <script>
    ...
    <div id="wrapper">
                        ...
                        <div class="controls">
                          <div class="row">
                            ...
                            <div class="col-md-4">
                              ...
                              <div class="form-group"><label>Description*</label> <input type="text" placeholder="Description" class="form-control" id="description" required="" maxlength="12 " ></div>
                            </div>

                            <div class="col-2"></div>
                            <div class="col-md-4">
                              <div class="form-group"><label>Status*</label><input type="text"  placeholder=" Status" class="form-control" id="label" required="" maxlength="12"></div>
                            </div>
       ...
       <script src="../../../../static/js/plugins/jquery-ui/jquery-ui.min.js"></script>
         ...
         <script src="../js/addStatus.js?v=" + $.getCurrentVersion()></script>
