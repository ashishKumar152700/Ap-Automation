...
<body>
  ...
  <script>
    ...
    <div id="wrapper">
                        ...
                        <div class="controls">
                          <div class="row">
                            ...
                            <div class="col-md-4">
                              ...
                              <div class="form-group"><label>Description*</label> <input type="text" placeholder="Description" class="form-control" required="" maxlength="12 " id="input-text2"></div>
                            </div>
                            <div class="col-2"></div>
                            <div class="col-md-4">
                              <div class="form-group"><label>Status*</label><input type="text" placeholder="Status" class="form-control" required="" maxlength="12" id="input-text3"></div>
                            </div>
       ...
       <script src="../js/updateStatus.js?v=" + $.getCurrentVersion()></script>
