...
<body>
                                            ...
                                            <div class="d-flex ">
                                                <div class="input-group ">
                                                    <input type="text" class="form-control column_filter"
                                                        placeholder="Label Name" aria-label="Admin Theme"
                    ...
                    <div class="ibox ">
                        <div class="ibox-content py-2">
                            <div class="text-center my-2 d-flex justify-content-around">
                                <button id="deleteAll" class="btn btn-primary d-none">Delete Selected </button>
                                <a class="btn btn-primary" href="labelMaster.jsp"><i class="fa fa-plus"> </i> Add
                                   Label</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="ibox">
                        <div class="ibox-content">
                            <table id="Dtable" class="display responsive nowrap text-left" style="width: 100%">
                                <thead>
                                    <!-- <th class="text-left d-none" data-hide="phone"><input type="checkbox" name="" id="select_all" ></th> -->
                                    <th class="text-left" data-hide="phone">ID</th>
                                    <!-- <th class="text-left" data-hide="phone">Label Id</th> -->
                                    <th class="text-left" data-hide="phone">Label Name </th>
                                    <th class="text-left" data-hide="phone">Tag Name</th>
                                            ...
                                            <form class="contact-form" id="form">
                                              <div class="controls">
                                                <div class="row">
                                                  <div class="col-1"></div>
                                                  <div class="col-md-4">
                                                    <!-- <div class="form-group"><label>Label ID*</label> <input type="text" placeholder="Label ID" class="form-control" id="label_id" required="" maxlength="12 " disabled ></div> -->
                                                    <div class="form-group"><label>Label Name*</label><input type="text"  placeholder=" Label Name" class="form-control" id="label_name" required="" maxlength="12" disabled></div>
                                                    <div class="form-group"><label>Tag Name*</label> <input type="text" placeholder="Tag Name" class="form-control" id="tag" required="" maxlength="12 " disabled ></div>

                                                  </div>
                                                  <div class="col-2"></div>
                                                  <div class="col-md-4">
                                                    
                                                    <div class="form-group"><label>Label Required*</label><input type="text"  placeholder=" Label Required" class="form-control" id="label_required" required="" maxlength="12" disabled></div>
    ...
    <!-- Status JS -->
    <script src="../js/label.js?v=" + $.getCurrentVersion()></script>
