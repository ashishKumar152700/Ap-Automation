...
<body>
                                    ...
                                    <td class=" col-12 ">
                                        <div class="d-flex ">
                                            <div class="input-group ">
                                                <input type="text" class="form-control column_filter" placeholder="Tag"
                                ...
                                <form class="contact-form" id="form">
                                    <div class="controls">
                                        <div class="row">
                                            ...
                                            <div class="col-1"></div>
                                            <div class="col-md-4">
                                                <!-- <div class="form-group"><label>Label ID*</label><input type="text"
                                                        placeholder="Label Id" class="form-control" id="labelid"
                                                        required="" maxlength="12 "></div> -->
                                                        ...
                                                        <div class="form-group"><label>Label Name*</label><input type="text"
                                                                placeholder=" Label Name" class="form-control" id="labelname"
                                                                required="" ></div>
                                                        <div class="form-group"><label>Tag Name*</label><input type="text"
                                                            placeholder="Tag Name" class="form-control" id="tagname"
                                                            required=""></div>
                                                            ...
                                                            <div class="col-md-4">
                                                                ...
                                                                <div class="form-group"><label>GRN Column*</label> <select id="grn_column" class="form-control form-select h-100 w-100 pl-2" name="new_labels"
                                                                    data-placeholder="Select a variation">
                                                                    
                                                                </select></div>

                                                                <div class="form-group"><label>Tag Description*</label><input type="text"
                                                            placeholder="Tag Description" class="form-control" id="tagdescription"
                                                            required=""></div>

                                                                <div class="form-group"><label>Sequence*</label><input type="text"
                                                            placeholder="Sequence" class="form-control" id="sequence"
                                                            required=""></div>
                                                            ...
                                                            <div class="form-group"><label>Label
                                                                ...
                                                                id="labelrequired" readonly></div>

                                                            
                                                <!-- <div class="form-group"><label>Label
                                                        Required*</label>&nbsp;&nbsp;&nbsp;<input type="checkbox"
                                                        id="labelrequired" maxlength="25" readonly></div> -->
    ...
    <!-- addStatus JS -->
    <script src="../js/labelMaster.js?v=" + $.getCurrentVersion()></script>
