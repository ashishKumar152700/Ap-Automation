...
<html>
    ...
    <head>
        ...
        <title>Update Tolerance Limit</title>
...
<body>
  ...
  <script>
    ...
    <div id="wrapper">
                        ...
                        <div class="controls">
                          <div class="row">
                            ...
                            <div class="col-md-4">
                              ...
                              <div ><label>Process ID*</label><br> <select class="form-control" id="label_type" name="new_labels">
                            ...
                            <div class="col-2"></div>
                            <div class="col-md-4">
                              <div class="form-group"><label>Tolerance*</label><input type="text" placeholder="Label Name" class="form-control" required="" maxlength="25" id="input-text2"></div>
       ...
       <script src="../js/updateTolerance.js?v=" + $.getCurrentVersion()></script>
