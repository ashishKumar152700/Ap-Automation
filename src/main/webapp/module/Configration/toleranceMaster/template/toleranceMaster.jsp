...
<body>
                                            ...
                                            <div class="d-flex ">
                                                <div class="input-group ">
                                                    <input type="text" class="form-control column_filter"
                                                        placeholder="Process ID" aria-label="Admin Theme"
                    ...
                    <div class="ibox ">
                        <div class="ibox-content py-2">
                            <div class="text-center my-2">
                                <a class="btn btn-primary" href="addTolerance.jsp"><i class="fa fa-plus"> </i> Add
                                   Tolerance</a>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="ibox-content">
                            <table id="Dtable" class="display responsive nowrap text-left" style="width: 100%">
                                <thead>
                                    ...
                                    <th class="text-left" data-hide="phone">Process ID</th>
                                    <th class="text-left" data-hide="phone">Tolerance</th>
                                              ...
                                              <div class="controls">
                                                <div class="row">
                                                  ...
                                                  <div class="col-md-4">
                                                    ...
                                                    <div class="form-group"><label>Process ID*</label><input type="text"  placeholder="Process ID" class="form-control" id="label_name" required="" maxlength="12" disabled></div>
                                                    

                                                  </div>
                                                  <div class="col-2"></div>
                                                  <div class="col-md-4">
                                                    <div class="form-group"><label>Tolerance*</label><input type="text"  placeholder="Tolerance" class="form-control" id="label_required" required="" maxlength="12" disabled></div>
    ...
    <script src="../js/toleranceMaster.js?v=" + $.getCurrentVersion()></script>
