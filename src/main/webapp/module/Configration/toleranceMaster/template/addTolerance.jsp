...
<body>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <!-- <div class="form-group"><label>Label ID*</label><input type="text"
                                                        ...
                                                        <div class="form-group"><label>Process ID*</label> <select id="label_type" class="form-select py-2 h-100 w-100 pl-2" name="new_labels">
                                                            ...
                                                            <div class="col-md-4">
                                                                ...
                                                                <div class="form-group"><label>Tolerance*</label><input type="text"
                                                                    placeholder="Tolerance" class="form-control" id="labelname"
                                                                    required="" maxlength="25"></div>

                                                            <!-- <div class="form-group"><label>Tolerance*</label> <select id="label_type" class="form-select py-2 h-100 w-100 pl-2" name="new_labels">
                                                                <option value="">Nothing Selected</option>
    ...
    <script src="../js/addTolerance.js?v=" + $.getCurrentVersion()></script>
