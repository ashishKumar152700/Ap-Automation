...
<body>
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-4">
                        <div class="form-group"><label>Error Code*</label> <input type="text" placeholder="Error Code"
                            class="form-control" id="errorcode" required="" maxlength="12 "></div>
                            <div class="form-group"><label>Error Description*</label><input type="text" placeholder="Error Description"
                              class="form-control" id="errordescription" required="" maxlength="20"></div>

                            </div>
                            <div class="col-2"></div>
                            <div class="col-md-4">
                              <div class="form-group"><label>Error Type*</label><input type="text" placeholder="Error Type"
                                class="form-control" id="errortype" required="" maxlength="20"></div>
                                <div class="form-group"><label>Error Resolution*</label> <input type="text" placeholder="Error Resolution"
                                  class="form-control" id="errorresolution" required="" maxlength="20"></div>
  ...
  <!-- addStatus JS -->
  <script src="../js/errorMaster.js?v=" + $.getCurrentVersion()></script>
