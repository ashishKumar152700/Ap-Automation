...
<head>
  ...
  <title>Update Error Master</title>
...
<body>
                        ...
                        <div class="form-group"><label>Error Code*</label> <input type="text" placeholder="Error Code"
                            ...
                            <div class="col-md-4">
                              <div class="form-group"><label>ErrorType*</label><input type="text" placeholder="ErrorType"
                                ...
                                <div class="form-group"><label>ErrorResolution*</label> <input type="text" placeholder="ErrorResolution"
  ...
  <!-- updateStatus JS -->
  <script src="../js/updateerrorMaster.js?v=" + $.getCurrentVersion()></script>
