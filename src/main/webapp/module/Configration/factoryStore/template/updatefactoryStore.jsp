...
<body>
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-4">
                        <div class="form-group"><label>Store Code*</label> <input type="text" placeholder="Store Code"
                          class="form-control" id="store_code" required="" maxlength="20 "></div>
                          <div class="form-group"><label>Store Name*</label><input type="text" placeholder="Store Name"
                            class="form-control" id="store_name" required="" maxlength="20"></div>
                              
                                <div class="form-group d-none"><label for="accessories">Gate Type*</label><br><select name="Type" id="type" placeholder="Gate Type"><option value = "Inward">Inward</option><option value = "Outward">Outward</option></select></div>
                            </div>
  ...
  <!-- updateStatus JS -->
  <script src="../js/updatefactoryStore.js?v=" + $.getCurrentVersion()></script>
