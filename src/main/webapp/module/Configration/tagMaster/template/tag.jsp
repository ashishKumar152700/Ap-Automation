...
<body>
                    ...
                    <div class="ibox ">
                        <div class="ibox-content py-2">
                            <div class="text-center my-2">
                                <a class="btn btn-primary" href="tagMaster.jsp"><i class="fa fa-plus"> </i> Add
                                   Tag</a>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="ibox-content">
                            <table id="Dtable" class="display responsive nowrap text-left" style="width: 100%">
                                <thead>
                                    ...
                                    <th class="text-left" data-hide="phone">Tag Description</th>
                                            ...
                                            <form class="contact-form" id="form">
                                              <div class="controls">
                                                <div class="row">
                                                  <div class="col-1"></div>
                                                  <div class="col-md-4">
                                                    <!-- <div class="form-group"><label>Code*</label> <input type="text" placeholder="Code" class="form-control" id="code" required="" disabled ></div> -->
                                                    <div class="form-group"><label>Tag Name*</label><input type="text"  placeholder="Tag Name" class="form-control" id="tagname" required=""  disabled></div>
                                                </div>
                                                <div class="col-2"></div>
                                                <div class="col-md-4">
                                                    <div class="form-group"><label>Tag Description*</label> <input type="text" placeholder="Tag Description" class="form-control" id="description" required=""  disabled ></div>
                                                  </div>
                                                  </div>
    ...
    <!-- Status JS -->
    <script src="../js/tag.js?v=" + $.getCurrentVersion()></script>
