...
<body>
  ...
  <script>
    ...
    <div id="wrapper">
                      ...
                      <form class="contact-form" id="form1">
                        <div class="controls">
                          <div class="row">
                            <div class="col-1"></div>
                            <div class="col-md-4">
                              <!-- <div class="form-group"><label>Code*</label> <input type="text" placeholder=" Code" class="form-control" required="" maxlength="12 " id="input-text1"></div> -->
                              <div class="form-group"><label>Tag Name*</label><input type="text" placeholder="Tag Name" class="form-control" required="" maxlength="12" id="input-text2"></div>
                            </div>
                            <div class="col-2"></div>
                            <div class="col-md-4">
                              <div class="form-group"><label>Tag Description*</label> <input type="text" placeholder="Tag Description" class="form-control" required="" maxlength="12 " id="input-text3"></div>
                            </div>
       ...
       <script src="../js/updatetagMaster.js?v=" + $.getCurrentVersion()></script>
