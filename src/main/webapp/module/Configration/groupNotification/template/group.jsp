...
<body>
                                            ...
                                            <div class="d-flex ">
                                                <div class="input-group ">
                                                    <input type="text" class="form-control column_filter"
                                                        placeholder="Group" aria-label="Admin Theme"
                    ...
                    <div class="ibox ">
                        <div class="ibox-content py-2">
                            <div class="text-center my-2">
                                <a class="btn btn-primary" href="groupNotification.jsp"><i class="fa fa-plus"> </i> Add
                                   GroupNotification</a>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="ibox-content">
                            <table id="Dtable" class="display responsive nowrap text-left" style="width: 100%">
                                <thead>
                                    ...
                                    <th class="text-left" data-hide="phone">Group Name</th>
                                    ...
                                    <th class="text-left" data-hide="phone">SupplierNumber </th>
                                            ...
                                            <form class="contact-form" id="form">
                                              <div class="controls">
                                                <div class="row">
                                                  ...
                                                  <div class="col-1"></div>
                                                  <div class="col-md-4">
                                                       <div class="form-group"><label>Group Name*</label> <input type="text"
                                                        placeholder="Name" class="form-control" id="groupname" required=""
                                                    ...
                                                    <div class="form-group"><label> Name*</label> <input type="text"
                                                        ...
                                                        <div class="form-group"><label>Store Id*</label> <input type="text"
                                                            placeholder="Store Id" class="form-control" id="storeId" required=""
                                                             disabled></div>
                                                  </div>
                                                  <div class="col-2"></div>
                                                  <div class="col-md-4">
                                                    <div class="form-group"><label>Email*</label> <input type="text"
                                                        placeholder="Email" class="form-control" id="email" required=""
                                                        maxlength="20 " disabled></div>
                                                        <div class="form-group"><label>VendorCode*</label> <input type="text"
                                                            placeholder="VendorCode" class="form-control" id="vendor_code" required=""
                                                            maxlength="20 " disabled></div>

                                                        <div class="form-group"><label>Unit Name*</label> <input type="text"
                                                                placeholder="Unit Name" class="form-control" id="unitName" required=""
                                                                disabled></div>
    ...
    <!-- Status JS -->
    <script src="../js/group.js?v=" + $.getCurrentVersion()></script>
