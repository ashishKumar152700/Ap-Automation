                    ...
                    <div class="row">
                      ...
                      <div class="col-md-4">
                        ...
                        <div class="form-group"><label>UserName*</label><input type="text" placeholder=" UserName"
                            class="form-control" id="input-text3" required="" maxlength="12"></div>
                        <div class="form-group"><label>Password*</label>
                          <div class="input-group">
                            <input type="password" placeholder=" Password" class="form-control pwd" id="input-text4"
                      ...
                      <div class="col-md-4">
                        <div class="form-group"><label>SMTP Server*</label> <input type="text" placeholder="SMTPServer"
                            class="form-control" id="input-text5" required="" maxlength="12 "></div>
                        <div class="form-group"><label>SMTP Port*</label> <input type="number" placeholder="SMTPPort"
                            class="form-control" id="input-text6" required="" maxlength="12 "></div>
                        <div class="form-group" id="input-text7"><label>Connection Encryption*</label><br>
                        ...
                        <div class="form-group"><label>Debugging*</label>&nbsp;&nbsp;<input type="checkbox"
                            id="input-text8" maxlength="12 "></div>
                      </div>
