                                            ...
                                            <div class="d-flex ">
                                                <div class="input-group ">
                                                    <input type="text" class="form-control column_filter"
                                                        placeholder="Name" aria-label="Admin Theme"
                    ...
                    <div class="ibox ">
                        <div class="ibox-content py-2">
                            <div class="text-center my-2">
                                <a class="btn btn-primary" href="emailSetup.jsp"><i class="fa fa-plus"> </i> Add
                                    Email</a>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="ibox-content">
                            <table id="Dtable" class="display responsive nowrap text-left" style="width: 100%">
                                <thead>
                                    ...
                                    <th class="text-left" data-hide="phone">Priority </th>
                                    <th class="text-left" data-hide="phone">Connection </th>
                                    <th class="text-left" data-hide="phone">Debugging </th>
                                    <th class="text-left" data-hide="phone">SMTPServer </th>
                                    <th class="text-left" data-hide="phone">SMTPPort </th>
                                                    ...
                                                    <form class="contact-form" id="form">
                                                        <div class="controls">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-2"></div>
                                                                <div class="col-md-4">
                                                                    <div class="form-group"><label>SMTP
                                                                            Server*</label><input type="text"
                                                                            placeholder=" SMTP Server"
                                                                            class="form-control" id="smtpserver"
                                                                            required="" maxlength="12" disabled></div>
                                                                    <div class="form-group"><label>SMTP
                                                                            Port*</label><input type="text"
                                                                            placeholder="SMTP Port" class="form-control"
                                                                            id="smtpport" required="" maxlength="12"
                                                                            disabled></div>
                                                                    <div class="form-group">
                                                                        <label>Connection*</label><input type="text"
                                                                            placeholder="Connection"
                                                                            class="form-control" id="input-text7"
                                                                            required="" maxlength="12" disabled>
                                                                    </div>
                                                                    <div class="form-group">
                                                                        <label>Debugging*</label><input type="checkbox"
                                                                            placeholder="Debugging" id="input-text8"
                                                                            required="" maxlength="12" disabled>
                                                                    </div>
