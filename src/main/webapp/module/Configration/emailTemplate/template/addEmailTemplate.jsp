...
<body>
                                ...
                                <form class="contact-form" id="form">
                                    <div class="controls">
                                        <div class="row">
                                            ...
                                            <div class="col-2"></div>
                                            <div class="col-md-4">
                                                <div class="form-group"><label>Email Subject*</label> <input type="text"
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-md-4">
                                                                            ...
                                                                            <div class="form-group"><label>To (Emails)
                                                                                </label><input type="address"
                                                                                    id="to_email" class="form-control" required></div>
    ...
    <script src="../js/addEmailTemplate.js?v=" + $.getCurrentVersion()></script>
