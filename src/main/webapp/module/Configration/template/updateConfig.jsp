...
<script>
                        ...
                        <div class="controls">
                          <div class="row">
                            ...
                            <div class="col-md-4">
                              ...
                              <div class="form-group"><label>Password*</label> <input type="text" required="" placeholder="JDE Password" class="form-control" required=""  maxlength="12 " id="jdePassword"></div>
                            ...
                            <div class="col-2"></div>
                            <div class="col-md-4">
                              <div class="form-group"><label for="accessories">Type*</label> <br><select name="Env" id="jdeEnv" placeholder=""><option value = "JDE"> JDE</option><option value = "JAVA"> JAVA</option><option value = "OCR"> OCR</option></select></div>
                              <div class="form-group"><label for="accessories">Env*</label> <br><select name="Type" id="jdeType" placeholder=""><option value = "DV"> DV</option><option value = "PD"> PD</option><option value = "PY"> PY</option></select></div><br>
                            ...
                            <div class="px-2 offset-1 my-3 d-flex justify-content-start ">
                              <button type="button"  id="cancel" class="btn btn-outline-danger pt-2 m-1">Cancel</button>
    ...
    <script src="../../../custom/js/breadcrumb.js"></script>
        ...
        <script src="../js/updateConfig.js?v=" + $.getCurrentVersion()></script>
