...
<head>
    ...
    <title>Update companyMaster</title>
...
<body>
                                    ...
                                    <div class="controls">
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" maxlength="20" id="input-text1"
                                                ...
                                                <div class="form-group">
                                                    <input type="text" maxlength="15" id="input-text2"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" maxlength="20" id="input-text3"
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div class="form-group">
                                                    <label>Name*</label>
                                                    <input type="text" maxlength="30" id="input-text4"
                                        ...
                                        <div class="row">
                                            <div class="px-2 offset-1 my-3 d-flex justify-content-start ">
                                                ...
                                                <button type="submit" class="btn add btn-primary pt-2 m-1" id="add">Save
                                                    Changes</button>
                                            </div>
                                        </div>
                                    </div>
    ...
    <!-- updateNextNumber  JS -->
    <script src="../js/updateCompany.js?v=" + $.getCurrentVersion()></script>
