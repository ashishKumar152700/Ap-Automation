...
<body>
  ...
  <script>
                      ...
                      <form class="contact-form" id="form">
                        <div class="controls">
                          <div class="row">
                            <div class="col-1"></div>
                            <div class="col-md-4">
                              <div class="form-group"><label>Role Code*</label> <input type="text" placeholder="Role Code" class="form-control" required="" id="form6Example1"></div>
                              
                            </div>
                            <div class="col-2"></div>
                            <div class="col-md-4">
                              <div class="form-group"><label>Role Description*</label><input type="text" required="" id="form6Example5" placeholder="Role Description" class="form-control"></div>
    ...
    <script src="../../../custom/js/breadcrumb.js"></script>
       ...
       <script src="../js/addRole.js?v=" + $.getCurrentVersion()></script>
