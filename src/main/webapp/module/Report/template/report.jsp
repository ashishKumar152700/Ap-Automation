...
<body>
                          ...
                          <div class="ibox-content py-3 d-flex">
                              ...
                              <table cellspacing="0" cellpadding="4" class="col-3">
                                <tbody>
                                  <tr id="filter_col2" data-column="1" class="">
                                      <td class="col-12">
                                          <label for="col3_filter"> <b> From Date</b></label>
                                          <div class="d-flex ">
                                              <div class="input-group">
                                                  <!-- <input type="text" name="" id="" class="form-control"> -->
                                                  <input type="text" readonly class="form-control column_filter"
                                                      placeholder="DD-MMM-YY" aria-label="Admin Theme"  id="col3_filter" autocomplete="off"/>
                              ...
                              <table cellspacing="0" cellpadding="4" class="col-3">
                                  <tbody>
                                      <tr id="filter_col2" data-column="1" class="">
                                          <td class="col-12">
                                              <label for="col4_filter"> <b> To Date</b></label>
                                              <div class="d-flex ">
                                                  <div class="input-group">
                                                      <!-- <input type="text" name="" id="" class="form-control"> -->
                                                      <input type="text" readonly class="form-control column_filter"
                                                          placeholder="DD-MMM-YY" aria-label="Admin Theme"  id="col4_filter" autocomplete="off"/>
                                                          <label class="input-group-text d-none" id="calendar" for="dateInput">
                                                              <i class="fa fa-calendar" ></i>
                                                            </label>
                                                      <!-- <input type="date" class="form-control column_filter"
                              ...
                              <table cellspacing="0" cellpadding="4" class="col-3">
                                  <tbody>
                                      <tr id="filter_col3" data-column="1" class=" ">
                                          <td class="col-12 ">
                                              <label for="export-all"> <b>Export To Excel</b></label>
                                              <div class="d-flex justify-content-between custom-width-20vw">
                                                <!-- <button type="button" class="btn btn-primary" id="excel-table" >Export To Excel</button> -->
                                                <button type="button" class="btn btn-primary ml-2" id="export-all">Fetch Records</button>
                        ...
                        <div class="ibox-content">
                            ...
                            <table id="Dtable" class="display responsive nowrap text-left" style="width: 100%">
                                ...
                                <thead>
                                    ...
                                    <th class="text-left" data-hide="phone,tablet">Date</th>
                                    ...
                                    <th class="text-left" data-hide="phone">Status</th>
                                    <th class="text-left d-none" data-sort-ignore="true"></th>
                                </thead>
                            </table>
                        </div>
                    </div>
    ...
    <script src="../js/report.js?v=" + $.getCurrentVersion()></script>
