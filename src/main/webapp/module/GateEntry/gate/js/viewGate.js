...
$.ajax({
    ...
    $.debitNote(obj)
        ...
        console.log('payload_voucher_number_details ---->' ,payload_voucher_number_details);
        ...
        var invoice_numbers = data.data[0].invoice_number==null?"":$("#invoice_number").val(data.data[0].invoice_number.split(" ").join(""));
        var invoice_numberss = data.data[0].invoice_number==null?"":$("#invoice_noo").val(data.data[0].invoice_number.split(" ").join(""));
    ...
    $("#comp_search").click(()=>{
        ...
        $.ajax ({
            ...
            $("#delete_unnessary").click(()=>{
                ...
                {
                    console.log(Matched_item.flat(500).includes($(".po_item")[i]?.value) && Matched_line_no.flat(Infinity).includes($(".line_numm")[i]?.value));
