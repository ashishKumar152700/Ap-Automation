            ...
            <div class="py-0" id="loader1">
              ...
              <div class="ibox-content py-3 px-2 pl-4">
                ...
                <div class="row justify-content-around">
                  ...
                  <input
                    type="text"
                    class="form-control input_size fetch_check control_check col-5 align-self-center font-weight-bold pr-0 mr-3"
                    required=""
          ...
          <div class="col-12 px-1">
              <div class="panel panel-primary">
                  ...
                  <div class="panel-body d-flex justify-content-around">
                    ...
                    <div class="container px-1">
                      <button class="btn btn-danger col-sm-12" id="cancel1">Cancel</button>
                    </div>
                    <div class="container px-1">
