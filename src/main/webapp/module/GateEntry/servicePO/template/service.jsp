...
<html>
  <head>
    ...
    <link rel="stylesheet" href="../../gate/css/addGate.css" />
  ...
  <body>
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="input-group">
                                    <input
                                      ...
                                      class="form-control fetch_check vendor_invoice control_check"
                                    />
                                    <!-- <input type="button" id="vendor_code_search" class=" input-group-append btn btn-primary select" value="Select"> -->
                                  </div>
    ...
    <script src="../js/service.js?v=" + $.getCurrentVersion()></script>
