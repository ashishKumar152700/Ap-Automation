$(document).ready(() => {
  ...
  let add_detail_array=[...object.details];
  ...
  let option = object.status.label;
  let selectedCode = null; 
  
  function handleSelectChange() {
      let selectedOption = $("#col2_filter").find("option:selected");
      ...
      success: function (data, status, xhr) {
          if (xhr.status === 200) {
              for (let i = 0; i < data.data.length; i++) {
                  let $b = $(`<option value="${data.data[i].label}" data-code="${data.data[i].code}">${data.data[i].label}</option>`);
  ...
  $("#col2_filter").on("change", handleSelectChange);
  



console.log('--------------------radhe----------',object.status);
...
<div class="modal-dialog modal-xl">
                            ...
                            <div class="row">
                                ...
                                <div class="col-6 b-r" id="form3">
                                    ...
                                    <div class="form-group row"><label class="col-3 col-form-label">CGST RATE</label>
                                        <div class="col-9"><input type="text" class="form-control input_size check" required="" id="cgst_percentage" >
                                        </div>
                                    </div>
                                    <div class="form-group row"><label class="col-3 col-form-label">SGST RATE</label>
                                        <div class="col-9"><input type="text" class="form-control input_size check" required="" id="sgst_percentage" >
                                        </div>
                                    </div>
                                    <div class="form-group row"><label class="col-3 col-form-label">IGST RATE</label>
                                        <div class="col-9"><input type="text" class="form-control input_size check" required="" id="igst_percentage" >
                                        </div>
                                    </div>
                                    <div class="form-group row"><label class="col-3 col-form-label">CESS RATE</label>
                                        <div class="col-9"><input type="text" class="form-control input_size check" required="" id="cess_percentage" >
                                        </div>
                                    </div>
                                    <div class="form-group row"><label class="col-3 col-form-label">Taxable value</label>
                                        <div class="col-9"><input type="text" class="form-control input_size check" required="" id="taxable_value" >
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-6" id="form3">
                                    ...
                                    <div class="form-group row"><label class="col-3 col-form-label">CGST AMOUNT</label>
                                        <div class="col-9"><input type="text" class="form-control input_size check" required="" id="cgst_amount">
                                        </div>
                                    </div>
                                    <div class="form-group row"><label class="col-3 col-form-label">SGST AMOUNT</label>
                                        <div class="col-9"><input type="text" class="form-control input_size check" required="" id="sgst_amount">
                                        </div>
                                    </div>
                                    <div class="form-group row"><label class="col-3 col-form-label">IGST AMOUNT</label>
                                        <div class="col-9"><input type="text" class="form-control input_size check" required="" id="igst_amount">
                                        </div>
                                    </div>
                                    <div class="form-group row"><label class="col-3 col-form-label">CESS AMOUNT</label>
                                        <div class="col-9"><input type="text" class="form-control input_size check" required="" id="cess_amount">
                                        </div>
                                    </div>
                                    <div class="form-group row"><label class="col-3 col-form-label">Invoice Amount</label>
                                        <div class="col-9"><input type="text" class="form-control input_size check" required="" id="amount">
                                        </div>
                                    </div>
                                </div>
  ...
  add_detail_array.sort((a, b) => a.s_no - b.s_no);

  
  for (let i = 0; i < add_detail_array.length; i++) {
    
    $("#tab_logic_body").append(`<tr>
  
      <td><input type="text" class="form-control input_size s_no text-center"  value="${add_detail_array[i].s_no}" ></td>

     <td><input type="text" class="form-control input_size id text-center" style="width: 5rem;" readOnly value="${add_detail_array[i].id}" ></td>

      <td><input type="text" class="form-control input_size item_code text-center"  value="${add_detail_array[i].item_code}" ></td>
      <td><input type="text" class="form-control input_size item_description text-center"  value="${add_detail_array[i].description1}" ></td>
      <td><input type="text" class="form-control input_size fix hsn_code text-center"  value="${add_detail_array[i].hsn_code}"></td>
      <td><input type="text" class="form-control input_size fix uom text-center"  value="${add_detail_array[i].uom}"></td>
      <td><input type="text" class="form-control input_size fix quantity text-center"  value="${add_detail_array[i].quantity}"></td>
      <td><input type="text" class="form-control input_size fix unit_amount text-center"  value="${add_detail_array[i].unit_amount != null && add_detail_array[i].unit_amount != "" ? add_detail_array[i].unit_amount.replace(/[^\d.]/g, '') : add_detail_array[i].unit_amount} "></td>
      <td><input type="text" class="form-control input_size fix amount text-center"  value="${add_detail_array[i].amount != null && add_detail_array[i].amount != "" ? add_detail_array[i].amount.replace(/[^\d.]/g, '') : add_detail_array[i].amount}"></td>

       <td><input type="text" class="form-control input_size fix receipt_number text-center"  value="${add_detail_array[i].receipt_number != null && add_detail_array[i].receipt_number != "" ? add_detail_array[i].receipt_number.replace(/[^\d.]/g, '') : add_detail_array[i].receipt_number}"></td>

               <td><button class="btn btn-danger delete_row">Delete</button></td>

  
      </tr>`);
      console.log(typeof(add_detail_array[i]),'------------------------------');
                  ...
                  //   {
                      for (let i = 0; i < object.details.length; i++) {
                        ...
                        $("#tab_logic_body").append(`<tr>
                                        ...
                                        <td><input type="text" class="form-control input_size s_no text-center"  value="${object.details[i].s_no}" ></td>

                                        <td><input type="text" class="form-control input_size id text-center" readOnly value="${object.details[i].id}" ></td>

                                        <td><input type="text" class="form-control input_size item_code text-center"  value="${object.details[i].item_code}" ></td>
                                        <td><input type="text" id="description" class="form-control input_size item_description text-center"  value="${object.details[i].description}" ></td>
                                        <td><input type="text" class="form-control input_size fix hsn_code text-center"  value="${object.details[i].hsn_code}"></td>
                                        <td><input type="text" class="form-control input_size fix uom text-center"  value="${object.details[i].uom}"></td>
                                        <td><input type="text" class="form-control input_size fix quantity text-center"  value="${object.details[i].quantity}"></td>
                                        <td><input type="text" class="form-control input_size fix unit_amount text-center"  value="${object.details[i].unit_amount}"></td>
                                        <td><input type="text" class="form-control input_size fix amount text-center"  value="${object.details[i].amount}"></td>    
                                        <td><input type="text" class="form-control input_size fix receipt_number text-center"  value="${object.details[i].receipt_number}"></td>  
                                        <td><button class="btn btn-danger delete_row">Delete</button></td>
...
let i = add_detail_array.length;

$("#add_row").click(function() {
   
    i++;
    $('#tab_logic_body').append(`<tr id="addr${i}">
        <td><input type="text"  value="${i}" class="form-control s_no"/></td>

        <td><input type="text" name="id" placeholder="id" class="form-control id" readOnly/></td>

        <td><input type="text" name="item_code" placeholder="Item Code" class="form-control item_code"/></td>
        
        <td><input type="text" name="item_desc" placeholder="Item Description" class="form-control item_description"/></td>
        <td><input type="text" name="hsn_code" placeholder="Hsn Code" class="form-control hsn_code"/></td>
        <td><input type="text" name="uom" placeholder="UOM" class="form-control uom"/></td>
        <td><input type="text" name="qty" placeholder="Qty" class="form-control quantity"/></td>
        <td><input type="text" name="unit_rate" placeholder="Unit Rate" class="form-control unit_amount"/></td>
        <td><input type="text" name="amount" placeholder="Amount" class="form-control amount"/></td>
        <td><input type="text" name="receipt_number" placeholder="Receipt Number" class="form-control receipt_number"/></td>
        <td><button class="btn btn-danger delete_row">Delete</button></td>
    </tr>`);
});
...
function updateSerialNumbers() {
    $('#tab_logic_body tr').each(function(index, tr) {
        $(tr).find('input[name="sno[]"]').val(index + 1);
    });
}
...
$("#po_no_select_modal").click(()=>{
  ...
  $("#submit_gate").click((e) => {
    ...
    $("#tab_logic_body tr").each(function(){
        var row = $(this);
        var rowData = {
            s_no: row.find(".s_no").val(),
            id: row.find(".id").val(),
            
            item_code: row.find(".item_code").val(),
            description1: row.find(".item_description").val(),
            hsn_code: row.find(".hsn_code").val(),
            uom: row.find(".uom").val(),
            quantity: row.find(".quantity").val(),
            unit_amount: row.find(".unit_amount").val(),
            amount: row.find(".amount").val(),
            receipt_number: row.find(".receipt_number").val()
        };
        tableData.push(rowData);
    });
    
    console.log("existing object :" , add_detail_array);

    const finalarray = tableData.map((data,index) =>{

      // let existingObj = add_detail_array[index];

      console.log("data id  : ", data.id);
      let existingObj = add_detail_array.find(d => d.id == data.id ) ?? {}

      return {...existingObj,...data}
    } )

    console.log('finalarray    ',finalarray);

    object.details=[...finalarray]

    

    object.transactionType = $("#Transaction").val();

    object.status = {code : selectedCode}
      ...
      // }
          ...
          object.in_time = $("#in_time").val();
          object.vendor_code = $("#vendor_code").val();
          object.short_jde_msg = $("#short_jde_msg").val();
          try {
            ...
            success: function (data,status,xhr) {
              ...
              $("#spin_rem").addClass("d-none");
                ...
                if(xhr.status == 200)
                {
                    ...
                    window.location.href = `../template/gate.jsp`;
