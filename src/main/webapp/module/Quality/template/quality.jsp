                        ...
                        <div class="ibox-content">
                            ...
                            <table id="Dtable" class="display responsive nowrap text-left" style="width: 100%">
                                ...
                                <thead>
                                    ...
                                    <th class="text-left" data-toggle="true">Scan</th>
...
if (auth.includes("QUALITY")) {
        ...
        $(document).ready(() => {
            ...
            function cancelbutton() {
                if (status1 == "Quality") {
                    return '<button class="btn btn-outline-danger btn-sm delete">Cancel</button>&nbsp;&nbsp;';
                } else {
            ...
            $("#Dtable").on("click", ".gate_number", function () {
                ...
                window.open("../template/addQuality.jsp", "_self")
    ...
    <script src="../js/quality.js?v=" + $.getCurrentVersion()></script>
</body>
