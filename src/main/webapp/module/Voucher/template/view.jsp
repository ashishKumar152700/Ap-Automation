                                    ...
                                    <div class="col-9"><input type="text" readonly class="form-control input_size fetch_check"
                                            required="" id="supplier_gstin">
                                                ...
                                                <div class="col-6" id="form4">
                                                    ...
                                                    <div class="form-group row"><label class="col-4 col-form-label">Inovoice Amount</label>
...
<!-- adsfadfs -->
<div class="row for_width d-none" id="create-vc">
    <div class="col-12">
        <div class="panel panel-primary ">
            
            <div class="panel-body d-flex d-none" >
    ...
    <div class="col-12" >
        <div class="panel panel-primary">
            ...
            <div class="panel-body d-flex" >
                ...
                <div class="container px-1">
                    <input type="button" id="back_invoice" class="btn col-sm-12 btn-danger" value="Exit">
                </div>
                <!-- <div class="container px-1">
